...
const TEST_CALL: Call = {
  ...
  description:
    'Toto je testovacia výzva na testovanie uploadu príloh a dynamického formulára. Vyplňte všetky polia a nahrajte dokumenty.',
    ...
    sections: [
      {
        ...
        description: 'Informácie o projekte',
        fields: ['projectName', 'projectDesc', 'category'],
      },
