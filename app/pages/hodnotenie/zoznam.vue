...
<template>
  <div class="max-w-5xl mx-auto px-6 py-10">
    ...
    <div class="space-y-3">
      ...
      <div v-if="!filteredApplications.length" class="text-center py-16 bg-white rounded-lg border border-gray-100">
...
const statusFilters = computed(() => [
  ...
  { label: 'Rozhodnuté',    value: 'decided',    count: applications.filter(a => ['approved', 'rejected'].includes(a.status)).length },
])
