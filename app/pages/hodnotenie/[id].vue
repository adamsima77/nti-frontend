        ...
        >
          ...
          <div>
            ...
            <p class="text-xs text-success-600 mt-0.5">
              Vaše hodnotenie bolo zaznamenané a je viditeľné pre ostatných členov komisie.
            </p>
          </div>
        </div>
      </div>
...
const application = reactive({
  ...
  description:
    'EcoTrack je mobilná aplikácia umožňujúca používateľom sledovať a redukovať svoju uhlíkovú stopu prostredníctvom gamifikácie a personalizovaných odporúčaní. Cieľom je znížiť priemernú uhlíkovú stopu používateľa o 20% za 6 mesiacov.',
  documents: [
